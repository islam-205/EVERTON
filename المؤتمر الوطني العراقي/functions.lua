...
elseif UserID == 1765160742 then  return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر Programmer Jacker ♕\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1765160742 then  return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم Programmer Jacker ♕\n") 
elseif UserID == 1765160742 then  return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم Programmer Jacker ♕\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1765160742 then  return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد Programmer Jacker ♕\n")
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1765160742 then  return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد Programmer Jacker ♕\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور\n") 
elseif redis:sismember(blank..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المنشئ\n") 
