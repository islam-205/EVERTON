...
return '♡ اصدار سورس إيفرتون : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'♡ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس إيفرتون يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : إيفرتون](https://t.me/UP_II)' ,nil,inline,msg.id_)
return false
end
...
local inline = {{{text="-مبرمج السورس اضـغـط هـنـآ ",url="https://t.me/eljo_ker_m)'"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس](https://t.me/eljo_ker_m)' ,nil,inline,msg.id_)
return false
end
...
send_inline(msg.chat_id_,  "سورس إيفرتون 🔥" ,keyboard,'html')
end
...
if Black == 'welcome on' or Black == 'تفعيل الإيفرتون تيم' then
if redis:get(blank..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الإيفرتون تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الإيفرتون تيم')
redis:set(blank..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم الإيفرتون' then
if redis:get(blank..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم الإيفرتون سابقا')
redis:set(blank..'welc'..msg.chat_id_,'off')
redis:del(blank..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم الإيفرتون الترحيب')
end
end
...
if MsgText[1] == "البوب" or MsgText[1]=="ايهاب" then
local keyboard = {}
keyboard.inline_keyboard = {
{{text = 'مطور السورس.',url="https://t.me/UIX_XIU"},
{text = ' مطور السورس',url="https://t.me/UIX_XIU"}},
...
elseif Text== "سورس إيفرتون" or Text== "سورس إيفرتون" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد سورس مصري ](https://t.me/UP_II)")
...
elseif Text== "رفع الإيفرتون"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ لقد تم رفع إيفرتون بنجاح \n♡ اديلو إيفرتون\n")
elseif Text== "تنزيل الإيفرتون"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ لقد تم رفع إيفرتون بنجاح \n♡ اديلو إيفرتون\n")
...
elseif Text== "رفع إيفرتون"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ تم رفع الواد ضمن الزنوج بنجاح\n♡الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل إيفرتون"  then return sendMsg(msg.chat_id_,msg.id_,"♡ آههلآ  عـزيزي\n♡ تم ازاله الواد بعيدا عن الزنوج بنجاح \n♡الان تم ازلته من قائمه الزنوج\n")
...
elseif Text== "سورس" then return sendMsg(msg.chat_id_,msg.id_,"انتا ازاي مش عارف/nان انا علي افجر علي/nسورس مصري/n سورس إيفرتون/n")
